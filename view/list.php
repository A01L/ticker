                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Резервированные</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Ticker</a></li>
                                            <li class="breadcrumb-item active">Резервированные</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                             ...
                             <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Список брони</h4>
                                        <p class="card-subtitle mb-4"> Все брони в списке счтиаются актуальными до момента удалении брони или событии.</p>
                                            ...
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?=$row['group']?></td>
                                                        <td><?=$row['person']?></td>
                                                        <td><a href="list?dell=<?=$row['id']?>">Удалить</a></td>
                                                    </tr>
                                                        <?
                                                    }
                                                    ?>
